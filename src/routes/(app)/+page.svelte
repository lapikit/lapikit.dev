		...
		<div>
			...
			<div>
				<p>
					...
					<span class="accent-text">{command[application.pkg_selected]['launch-cli']}</span>. In fee
					minutes you can code with lapikit directly in your project
				</p>
