<script lang="ts">
	...
	import PageV2 from './page-v2.svelte';
	...
	let display: 'legacy' | 'v2' = $state('legacy');
...
{#if PUBLIC_DEV === 'true'}
	<div class="fixed top-0 right-0 z-8000" style="background: white; color: black;">
		<button onclick={() => (display = 'legacy')}>legacy</button>
		<button onclick={() => (display = 'v2')}>new</button>
	</div>
{/if}
						...
						<div class="sm:text-lg">
							...
							<ul class="mt-6!">
								...
								<li class="mb-2 flex gap-2">
									<kit:icon>
										<CircleCheck color="#30d158" />
									</kit:icon> Stop copying and duplicating CSS classes and start shipping better user
									interfaces
								</li>
							</ul>
						...
						>
							<div class="flex justify-between px-4 py-3">
								<div>
									...
									<p>
										Do you want to contribute to Lapikit? We provide a Contributor Guide to assist
				...
				>
					<div>
						...
						<p class="text-muted mt-6 text-center text-base text-balance sm:text-lg md:text-left">
							Lapikit is free and open source software distributed under the MIT License. You may
							help us grow by contributing to the project and becoming a sponsor. Every gift
							actually counts! As a Lapikit contributor, you will gain visibility into the roadmap,
							have a say in the project's development, be recognized on our website, and receive
							priority support
						</p>
